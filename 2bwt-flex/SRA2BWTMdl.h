...
#define SRA_STEP_ERROR_TYPE_EDIT_DISTANCE_BOUNDARY               4
#define SRA_STEP_ERROR_TYPE_NBM                                  8
#define SRA_STEP_ERROR_TYPE_OPTIONAL_NBM                         16
...
static const char SRA_STEP_ERROR_TYPE[][128] = {
    ...
    "!NOT ALLOWED!",
    "!NOT ALLOWED!",
    "SRA_STEP_ERROR_TYPE_NBM",
    "MISMATCH + NBM",
    "EDIT + NBM (Unimplemented)",
    "!NOT ALLOWED!",
    "EDIT BOUND + NBM (Unimplemented)",
    "!NOT ALLOWED!",
    "!NOT ALLOWED!",
    "!NOT ALLOWED!",
    "SRA_STEP_ERROR_TYPE_OPTIONAL_NBM" };

//----------------------------
// SRA2BWTMdl CTC#1
// Set this parameter to enable creation SRA model on the fly. The model getting
// would invoke the procedure to build up an SRA model in case one can't be found.
//#define SRA_2BWT_MDL_CREATE_ON_THE_FLY
//----------------------------
//----------------------------
// DEBUG FLAGS
//----------------------------
...
typedef struct SRAModelSet {
    int modelId;
    int maxReadLength;
    int minReadLength;
    SRASetting * aSettings;
    SRAIndex * aIndex;
    // SRA Models for Positive Strand
    SRAModel ** sraPModels;
    // SRA Models for Negative Strand
    SRAModel ** sraNModels;
} SRAModelSet;
...
SRAModelSet * SRAModelSetConstruct(SRASetting * aSettings, SRAIndex * aIndex,
                                    int modelId, int minReadLength, int maxReadLength);
