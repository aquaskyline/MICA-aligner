...
int SRAOutputGetNextRow(FILE * outFilePtr, OCCPositionCacheToDisk * outputRow) {
    return fread(outputRow, 1, sizeof(OCCPositionCacheToDisk), outFilePtr);
}
