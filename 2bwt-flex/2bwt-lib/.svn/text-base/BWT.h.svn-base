...
#define MIC_INDEX_OCC_INTERVAL 512

//MIC Implementation Requires Structure to be 64-bit aligned
// Hence the token ALIGN_64 is mandatory
ALIGN_64
typedef struct BWT {
    ...
    unsigned int *micOccValue;
    unsigned int micOccSizeInWord;
} BWT;
...
#define BWTOccValueExplicitMIC(bwt, occIndexExplicit, character) bwt->micOccValue[occIndexExplicit*ALPHABET_SIZE+character]
